function scr_itemget_anytype_text() //gml_Script_scr_itemget_anytype_text
{
    noroom = 0
    ...
    if (_itemtype == "money")
    {
        ...
        if (_itemid > 1)
            ...
            itemname = string(_itemid) + (stringsetloc(" Dark Dollar", "scr_itemget_anytype_text_slash_scr_itemget_anytype_text_gml_52_1"))
    }
    if (noroom == 0)

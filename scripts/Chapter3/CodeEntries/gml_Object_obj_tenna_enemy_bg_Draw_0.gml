...
if (minigametimecon == 0)
    draw_text_transformed_outline(camerax() + 320, cameray() + 50, stringsetloc("SCORE", 
    "obj_tenna_enemy_bg_slash_Draw_0_gml_0_0"), 2 + (sin(siner / 4) * 0.05), 1.5 + (sin(siner / 4) * 0.1), 16711680);

if (addscore > 0)
{
    draw_text_transformed_outline(camerax() + 320 + 114, cameray() + 50, stringsetloc("bonus", 
    "obj_tenna_enemy_bg_slash_Draw_0_gml_1_0"), 0.7 + (sin(siner / 6) * 0.2), 1.5, 16711680);
    draw_text_transformed_outline(camerax() + 320 + 110, cameray() + 80, "+" + string(addscore), 1 + (sin(siner / 6) * 0.2), 1.5, 16711680);
}

if (addscore < 0)
{
    draw_text_transformed_outline(camerax() + 320 + 110, cameray() + 50, stringsetloc("bet", 
    "obj_tenna_enemy_bg_slash_Draw_0_gml_2_0"), 1 + (sin(siner / 6) * 0.2), 1.5, 255);
...
if (minigametimecon > 1)
    draw_text_transformed_outline(camerax() + 330, cameray() + 66, stringsetloc("GAME TIME!", 
    "obj_tenna_enemy_bg_slash_Draw_0_gml_3_0"), 2 + (sin(siner / 4) * 0.05), 1.5 + (sin(siner / 4) * 0.1), 16711680);
...
var count = 0;
mysprite[0] = spr_gameshow_crowd_a;
mysprite[1] = spr_gameshow_crowd_a;
mysprite[2] = spr_gameshow_crowd_a;

if (init)
{
    ...
    if (con == 0 && (!i_ex(quizzler) || quizzler.con == 0 || con == 6))
    {
        ...
        var str_scale = min(3, 320 / string_width(quizstring))
        draw_text_transformed((1 + _tx) - (6 * _scale * (str_scale / 3)), _ty, string_hash_to_newline(quizstring), str_scale * _scale, str_scale * _scale, 0);
        draw_text_transformed(1 + _tx, _ty - (6 * _scale * (str_scale / 3)), string_hash_to_newline(quizstring), str_scale * _scale, str_scale * _scale, 0);
        draw_text_transformed(1 + _tx + (6 * _scale * (str_scale / 3)), _ty, string_hash_to_newline(quizstring), str_scale * _scale, str_scale * _scale, 0);
        draw_text_transformed(1 + _tx, _ty + (6 * _scale * (str_scale / 3)), string_hash_to_newline(quizstring), str_scale * _scale, str_scale * _scale, 0);
        draw_set_color(c_white);
        draw_text_transformed(_tx, _ty, string_hash_to_newline(quizstring), str_scale * _scale, 3 * _scale, 0);
        draw_set_color(gameshowblue);
    }
    ...
    if (con == 7)
    {
        draw_sprite_ext(scr_84_get_sprite("spr_quiz_results"), 0, camerax() + 320, cameray() + 112 + 10, 2, 2, 0, c_white, 1);
        drawquestion = 0;
        timer++;
        ...
        if (timer >= (_starttime + (_rate * 0)))
            draw_sprite_ext(scr_84_get_sprite("spr_quiz_answer_cursor"), 18 - su_answer[0], xloc + (hSpace * 0), 170, 2, 2, 0, su_answer[0] ? _so : _sx, 1);
        
        if (timer >= (_starttime + (_rate * 1)))
            draw_sprite_ext(scr_84_get_sprite("spr_quiz_answer_cursor"), 18 - kr_answer[0], xloc + (hSpace * 1), 170, 2, 2, 0, kr_answer[0] ? _ko : _kx, 1);
        
        if (timer >= (_starttime + (_rate * 2)))
            draw_sprite_ext(scr_84_get_sprite("spr_quiz_answer_cursor"), 18 - ra_answer[0], xloc + (hSpace * 2), 170, 2, 2, 0, ra_answer[0] ? _ro : _rx, 1);
        
        draw_sprite_ext(scr_84_get_sprite("spr_quiz_answer_cursor"), 19, xloc + (hSpace * 3), 170, 2, 2, 0, gameshowblue, 1);
        
        if (timer >= (_starttime + (_rate * 3)))
            draw_sprite_ext(scr_84_get_sprite("spr_quiz_answer_cursor"), 18 - su_answer[1], xloc + (hSpace * 4), 170, 2, 2, 0, su_answer[1] ? _so : _sx, 1);
        
        if (timer >= (_starttime + (_rate * 4)))
            draw_sprite_ext(scr_84_get_sprite("spr_quiz_answer_cursor"), 18 - kr_answer[1], xloc + (hSpace * 5), 170, 2, 2, 0, kr_answer[1] ? _ko : _kx, 1);
        
        if (timer >= (_starttime + (_rate * 5)))
            draw_sprite_ext(scr_84_get_sprite("spr_quiz_answer_cursor"), 18 - ra_answer[1], xloc + (hSpace * 6), 170, 2, 2, 0, ra_answer[1] ? _ro : _rx, 1);
        
        draw_sprite_ext(scr_84_get_sprite("spr_quiz_answer_cursor"), 19, xloc + (hSpace * 7), 170, 2, 2, 0, gameshowblue, 1);
        
        if (timer >= (_starttime + (_rate * 6)))
            draw_sprite_ext(scr_84_get_sprite("spr_quiz_answer_cursor"), 18 - su_answer[2], xloc + (hSpace * 8), 170, 2, 2, 0, su_answer[2] ? _so : _sx, 1);
        
        if (timer >= (_starttime + (_rate * 7)))
            draw_sprite_ext(scr_84_get_sprite("spr_quiz_answer_cursor"), 18 - kr_answer[2], xloc + (hSpace * 9), 170, 2, 2, 0, kr_answer[2] ? _ko : _kx, 1);
        
        if (timer >= (_starttime + (_rate * 8)))
            draw_sprite_ext(scr_84_get_sprite("spr_quiz_answer_cursor"), 18 - ra_answer[2], xloc + (hSpace * 10), 170, 2, 2, 0, ra_answer[2] ? _ro : _rx, 1);
    ...
    if ((con >= 3 && con <= 6) || timer_delay > 0)
    {
        ...
        if (con >= 3 && con <= 6 && timer_delay <= 0)
        {
            ...
            if (subcon >= 1)
                draw_sprite_ext(scr_84_get_sprite("spr_quiz_answer_cursor"), (rsel && rresult) ? 0 : 1, 200 + _coordOffset, 190 + (ralseicoord * 26) + _iconyoff, 2, 2, 0, c_white, 1);
            ...
            if (subcon >= 2)
                draw_sprite_ext(scr_84_get_sprite("spr_quiz_answer_cursor"), (ssel && sresult) ? 0 : 1, 200 + _coordOffset, 190 + (susiecoord * 26) + _iconyoff, 2, 2, 0, c_white, 1);
            
            if (subcon >= 3)
                draw_sprite_ext(scr_84_get_sprite("spr_quiz_answer_cursor"), (myanswer > -1 && correct) ? 0 : 1, 200, 190 + (menucoord[menu] * 26) + _iconyoff, 2, 2, 0, c_white, 1);
        }

...
tvsign = scr_marker(160, -174, scr_84_get_sprite("spr_dw_tv_tvtimeSign_half"));
scr_darksize(tvsign);
tvsign.depth = 1000189;
tvsign.image_speed = 0.08333333333333333;
mysterysign = scr_marker(176, -82, scr_84_get_sprite("spr_dw_tv_mysterySign_half"));
...
prize1object = scr_marker_jitter(camerax() + 20, cameray() + 180, scr_84_get_sprite("spr_dw_tv_prize_curtain"));
...
prize3object = scr_marker_jitter(camerax() + 10, cameray() + 10, scr_84_get_sprite("spr_dw_tv_prize_talkback"));
...
prize5object = scr_marker_jitter(camerax() + 220, cameray(), scr_84_get_sprite("spr_dw_tv_prize_gum"));

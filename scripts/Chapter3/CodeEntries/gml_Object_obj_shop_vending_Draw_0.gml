...
{
    if (menu >= 10 && menu < 18)
        draw_text(camerax() + 440, 420, stringsetsubloc("$~1", string_hash_to_newline(string(global.gold)), "obj_shop_vending_slash_Draw_0_gml_459_0"));
    else if (menu_dollar)
        draw_text(camerax() + 440, 420, stringsetsubloc("$~1", string(global.gold), "obj_shop_vending_slash_Draw_0_gml_460_0"));
    else
        draw_text((camerax() + 440) - 10, 420, stringsetsubloc("~1 PTs", string_hash_to_newline(string(global.flag[1044])), "obj_shop_vending_slash_Draw_0_gml_461_0"));

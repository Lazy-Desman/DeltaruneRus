...
if (con == 3 || con == 3.5)
{
    ...
    {
        if (commenttimer == 20)
            scr_createquizcomment(stringsetloc("Wh... WHAT!?", "obj_quizsequence_slash_Step_0_gml_224_0"), 0, 30, spr_tenna_hurt);
        ...
        if (commenttimer == 70)
            scr_createquizcomment(stringsetloc("It was CANCELLED!?#You gotta be kidding me!!", "obj_quizsequence_slash_Step_0_gml_235_0"), 0, 80, scr_84_get_sprite("spr_tenna_sad"), 0);
        
        if (commenttimer == 150)
            scr_createquizcomment(stringsetloc("No!! You're joking!! I...#I invested everything in puppets!!#Everything I had!", "obj_quizsequence_slash_Step_0_gml_239_0"), 0, 90, scr_84_get_sprite("spr_tenna_grasp"));
        
        if (commenttimer == 260)
            scr_createquizcomment(stringsetloc("... Alright. Ahem. It's fine.#Let's just keep going.#We're, having so much fun!", "obj_quizsequence_slash_Step_0_gml_243_0"), 0, 90, scr_84_get_sprite("spr_tenna_tie_adjust_b"));
        ...
        if (quizid == "lancer" && extra)
        {
            ...
            if (ralseicoord != 0)
            {
                if (timer == (starttime + (timespace * 0)))
                {
                    ...
                    quizzler.tenna.sprite_index = scr_84_get_sprite("spr_tenna_pose_podium");
                    quizzler.tenna.bounce = 1;
                ...
                {
                    quizzler.tenna.sprite_index = scr_84_get_sprite("spr_tenna_point_at_screen");
                    quizzler.tenna.bounce = 1;
                    endtimer = timer + 1;
...
if (con == 5)
{
    ...
    if (quizid == "whattime")
    {
        ...
        if (timer == (starttime + (timespace * 0)))
        {
            ...
            if (myanswer == 2)
            {
                ...
                quizzler.tenna.sprite_index = scr_84_get_sprite("spr_tenna_laugh_pose");
            }
    ...
    if (quizid == "favfood")
    {
        ...
        if (correct)
        {
            ...
            if (timer == (starttime + (timespace * 2)))
            {
                quizzler.tenna.sprite_index = scr_84_get_sprite("spr_tenna_nose_blossom");
                quizzler.tenna.bounce = 1;
            ...
            if (timer == (starttime + (timespace * 3)))
            {
                quizzler.tenna.sprite_index = scr_84_get_sprite("spr_tenna_point_up");
                quizzler.tenna.bounce = 1;
        ...
        else
        {
            ...
            if (timer == (20 + (timespace * 1)))
            {
                ...
                quizzler.tenna.sprite_index = scr_84_get_sprite("spr_tenna_tie_adjust_a");
                quizzler.tenna.bounce = 1;
    ...
    if (quizid == "channel")
    {
        if (timer == 20 && myanswer >= 0)
        {
            ...
            if (myanswer < 3)
            {
                scr_quizcomment_add(stringsetloc("That's right, Kris!#Smart kid!", "obj_quizsequence_slash_Step_0_gml_555_0"), 0, 60, scr_84_get_sprite("spr_tenna_hooray_armsup"));
                scr_quizcomment_add(stringsetloc("Now, let's see those RESULTS!", "obj_quizsequence_slash_Step_0_gml_556_0"), 0, 60, scr_84_get_sprite("spr_tenna_point_at_screen"));
            }
            else
            {
                scr_quizcomment_add(stringsetloc("What the... OTHER!?", "obj_quizsequence_slash_Step_0_gml_560_0"), 0, 45, spr_tenna_shocked);
                ...
                scr_quizcomment_add(stringsetloc("Smart... WHAT?#Are you calling me STUPID!?", "obj_quizsequence_slash_Step_0_gml_562_0"), 0, 60, scr_84_get_sprite("spr_tenna_tie_adjust_c"));
            }
        }
    }
    ...
    if (quizid == "smash")
    {
        ...
        if (timer == (starttime + (timespace * 1)))
        {
            ...
            var tesprite = scr_84_get_sprite("spr_tenna_pose_podium");
        ...
        if (timer == (starttime + (timespace * 3)))
        {
            ...
            quizzler.tenna.sprite_index = scr_84_get_sprite("spr_tenna_hooray_armsup");
            scr_tennabubble(tetalk, tbubx, tbuby, timespace, 1, quizzler.tenna, ttail);
        }
        ...
        if (timer == (starttime + (timespace * 4)))
        {
            ...
            quizzler.tenna.sprite_index = scr_84_get_sprite("spr_tenna_whisper_blush");
            scr_tennabubble(tetalk, tbubx, tbuby, timespace, 1, quizzler.tenna, ttail);
        }
    ...
    if (quizid == "tvtime")
    {
        ...
        if (correct)
        {
            ...
            if (timer == (starttime + (timespace * 0)))
            {
                safe_delete(obj_couchwriter);
                safe_delete(obj_tennatalkbubble);
                quizzler.tenna.sprite_index = scr_84_get_sprite("spr_tenna_pose");
                quizzler.tenna.bounce = 1;
        ...
        else
        {
            ...
            if (timer == (starttime + (timespace * 1)))
            {
                quizzler.tenna.sprite_index = scr_84_get_sprite("spr_tenna_tie_adjust_c");
                quizzler.tenna.bounce = 1;
    ...
    if (quizid == "sofun")
    {
        ...
        if (timer == (starttime + (timespace * 0)))
        {
            ...
            var tesprite = scr_84_get_sprite("spr_tenna_laugh_pose_teeth");
    ...
    if (quizid == "anotherword")
    {
        ...
        if (timer == (starttime + (timespace * 0)))
        {
            ...
            var tesprite = scr_84_get_sprite("spr_tenna_pose_podium_evil");
            
            if (!correct)
            {
                tetalk = stringsetloc("WRONG! WRONG! WRONG!!!", "obj_quizsequence_slash_Step_0_gml_630_0");
                tesprite = spr_tenna_evil;
            }
    ...
    if (timer >= endtimer)
    {
        ...
        if (board4)
        {
            if (timer == endtimer && (kr_answer[0] == 0 || su_answer[0] == 0 || ra_answer[0] == 0) && quizzler.tenna.sprite_index != scr_84_get_sprite("spr_tenna_point_up_b"))
            {
                quizzler.tenna.sprite_index = scr_84_get_sprite("spr_tenna_point_up_b");
                quizzler.tenna.bounce = 1;
            }

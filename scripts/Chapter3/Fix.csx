...
await Task.Run(() =>
{
    ...
    foreach (var codeName in jsonCodeUpdates.Keys) {
        ...
        {
            // ShowMessage("Несуществующий код '" + codeName + "'. Вероятнее всего у вас старая версия игры. Установщик продолжит свою работу, но возможно возникновение внутриигровых ошибок.");
            ScriptMessage("Несуществующий код '" + codeName + "'. Вероятнее всего у вас старая версия игры. Установщик прекратит свою работу, чтобы не возникло ошибок внутри игры.");
            throw new Exception("Несуществующий код '" + codeName + "'. Вероятнее всего у вас старая версия игры. Установщик прекратит свою работу, чтобы не возникло ошибок внутри игры.");
        }
        else
        {
            GetOrig(codeName);
